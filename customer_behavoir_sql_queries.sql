...
select item_purchased,(100*sum(CASE WHEN discount_applied='yes' THEN 1 ELSE 0 END) /COUNT(*))as discount_rate from customer group by item_purchased order by discount_rate desc limit 5;
